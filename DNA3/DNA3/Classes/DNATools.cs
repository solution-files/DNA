    ...
    public class DNATools : IDNATools {
        ...
        public async Task<bool> Initialize() {
            ...
            try {
                ...
                if (Pages.Count == 0) {
                    Context.Page.Add(new Page { Date = DateTime.Now, Slug = "introduction", Name = "Introduction", Subject = "Web Application Template", Content = "A cross-platform, open-source system refactored for ASP.NET Core and Syncfusion.", Icon = "fas fa-home" });
